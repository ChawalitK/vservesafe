 ...
 * @Version 1.0
 * @Package Database
 * https://github.com/moe85/MySQLi-CRUD-PHP-OOP/
 */
class Database
{
    /*
    ...
    private $db_user = "webusers"; // Change as required
    private $db_pass = "!QAZxsw2#"; // Change as required
    private $db_name = "vservesafe"; // Change as required
